...
<div class="row container">
            <form class="col s12" method="GET" id="cadastro" name="cadastro">
            {{ csrf_field() }}
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s6">
                        Estado
                        <select id="uf_usuario" name="uf_usuario" class="browser-default" name="tipo" id="tipo">
                ...
                <div class="center">
                    <input id="cadastrar" name="cadastrar" value="Cadastrar" type="submit" onclick="document.getElementById('cadastro').submit()">
                </div>
            </form>
            <br>
        </div>
